...
def index():
    ...
    entertainment = get_entertainment('entertainment')

    title = 'DailyBoomerang'
    return render_template('index.html',title = title, business = business,  sport = sport, entertainment = entertainment, science = science
    health = health, tech = tech)
